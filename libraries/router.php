...
$requick = array(
	...
	array("tbl" => "news", "field" => "id", "source" => "news", "com" => "ly-do-chon-bao-ve", "type" => "ly-do-chon-bao-ve", "menu" => false),
	
	array("tbl" => "product", "field" => "id", "source" => "product", "com" => "thu-vien-anh", "type" => "thu-vien-anh", "menu" => true),

	array("tbl" => "product", "field" => "id", "source" => "product", "com" => "chung-nhan", "type" => "chung-nhan", "menu" => true),
